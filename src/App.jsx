      ...
      <section className="about" id="about">
        <div className="about-container">
          ...
          <div className="about-text">
            ...
            <p>When I'm not coding, you can find me obsessing over my cats, keeping up with fashion and beauty, or finding new ways to bring creativity into everything I do.</p></div>
        </div>
      </section>
